...
<script>
import CoralSeaTab from './components/dynamic/CoralSeaTab.vue'
import LeyteGulfTab from './components/dynamic/LeyteGulfTab.vue'
import MidwayTab from './components/dynamic/MidwayTab.vue'
